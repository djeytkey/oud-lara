...
class AdminController extends Controller
{
    ...
    public function product_store(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            $imageName = Carbon::now()->timestamp . '.' . $imageExtension;
        ...
        if ($request->hasFile('images')) {
            ...
            foreach ($files as $file) {
                ...
                if ($gallery_check) {
                    $gallery_fileName = Carbon::now()->timestamp . '-' . $counter . '.' . $gallery_extension;
                    $this->GenerateProductThumbnailsImage($file, $gallery_fileName);
